...
fn list_end_after_start() {
    assert_cli::Assert::command(&["target/debug/days_between", "2017-01-01", "2017-01-03", "-l"])
    .succeeds()
    .and()
    .stdout().contains("2017-01-01")
    .and()
    .stdout().contains("2017-01-02")
    .and()
    .stdout().contains("2017-01-03")
    .unwrap();
}

#[test]
fn list_end_equals_start() {
    assert_cli::Assert::command(&["target/debug/days_between", "2017-01-01", "2017-01-01", "-l"])
    .succeeds()
    .and()
    .stdout().is("2017-01-01")
    .unwrap();
}
...
fn list_end_before_start() {
    ...
    .succeeds()
    .and()
    .stdout().contains("20170103")
    .and()
    .stdout().contains("20170102")
    .and()
    .stdout().contains("20170101")
    .unwrap();
}
